...
export const bobaedreamTokens: Token[] = [
  ...
  { name: "--bd-space-4", value: "4px", korean: "최소 간격", usage: "아이콘과 텍스트, 가격과 단위" },
  { name: "--bd-space-8", value: "8px", korean: "작은 간격", usage: "칩 간격, 썸네일 내부 여백" },
  { name: "--bd-space-12", value: "12px", korean: "기본 간격", usage: "카드 내부, 필터 레일" },
  { name: "--bd-space-16", value: "16px", korean: "섹션 간격", usage: "리스트 카드, 상세 정보 블록" },
