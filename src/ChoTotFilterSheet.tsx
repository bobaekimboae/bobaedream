...
const makerOptions = ["현대", "기아", "제네시스", "BMW", "벤츠", "아우디", "포르쉐", "랜드로버", "렉서스", "벤틀리", "페라리", "람보르기니", "롤스로이스", "맥라렌", "애스턴마틴", "코닉세그", "리막", "루시드", "폴스타", "애큐라", "DS", "마이바흐"];
const modelsByMaker: Record<string, string[]> = {
  현대: ["그랜저 GN7", "아이오닉 5"],
  기아: ["카니발 4세대", "쏘렌토 MQ4"],
  제네시스: ["G80 RG3"],
  BMW: ["3시리즈", "5시리즈", "X1", "X3", "1시리즈"],
  벤츠: [
