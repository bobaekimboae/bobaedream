...
const loaders = { dashboard: loadDashboard, registry: loadRegistry, categories: loadCategories, variables: loadVariables, schemas: loadSchemas, makeModel: loadMakeModel, integration: loadIntegration, audit: loadAudit };
...
function classifierPayload(preset, id) {
  ...
  if (preset === "forklift") return { ...base, vehicle_type_key: "FORKLIFT_LOGISTICS" };
