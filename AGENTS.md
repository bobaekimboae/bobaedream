...
- Place the Figma thumbnail rail from node `1956:17949` directly below the 305px detail hero photo: use an 8px gap, a 78px rail, five equal thumbnails across the 412px viewport, a 2px dark inset outline on the active thumbnail, and the exact exported play and next-arrow assets. Thumbnail taps, the next arrow, the main photo carousel, the active outline, and the `1/24` counter must remain synchronized.
